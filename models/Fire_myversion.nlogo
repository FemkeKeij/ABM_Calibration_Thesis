...
to go
  if not any? turtles  ;; either fires or embers
    [ stop ]
  if directions = 4 ;; added
   [ask fires
    [ ask neighbors4 with [pcolor = green]
        [ ignite ]
        set breed embers ]]
  if directions = 8 ;; added
   [ask fires
...
to clean ;; added
  random-seed 42 ;; set a random seed to ensure reproducibility
end
...
@#$#@#$#@
<experiments>
  <experiment name="Fire_four_density" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
