...
ggsave('figures/fire_piecewise_predtrue_direction.pdf')
```
...
ggsave('figures/fire_piecewise_density_metrics.pdf')
```
F1, kappa score, and MCC for directions:
```{r}
PlotErrorsDirections(regression_errors, n_plot = c(99, 792, 1584))

ggsave('figures/fire_piecewise_directions_metrics.pdf')
```
### Outcome variable
