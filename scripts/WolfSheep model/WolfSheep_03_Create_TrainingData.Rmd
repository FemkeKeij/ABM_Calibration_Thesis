...
What I've done here is to extend the time series so that they are all the same length and I can pivot to wide format. This enables me to use the values at each tick as predictors in the training algorithms more easily. I should probably think about doing something similar for the fire data, only it's not possible to do this with the scrambled ticks I think. I'd have to move the data not the ticks.
