...
```
Combination number 17 shows some dispersion. Otherwise, most runs seem to agree on the output and it seems reasonable to summarise using means. I will also add the minimum, maximum, and median to account for the cases where this is not reasonable.
