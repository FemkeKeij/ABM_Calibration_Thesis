...
RMSE_plots <- PlotRMSE(errors_long)
plot1 <- RMSE_plots[[1]][1]
ggsave('figures/ws_mrf_RMSE_full.pdf')
plot2 <- RMSE_plots[[1]][2]
ggsave('figures/ws_mrf_RMSE_sum.pdf')

# plot point predictive performance
ppp_plots <- PlotPPP(errors_long)
plot3 <- ppp_plots[[1]][1]
ggsave('figures/ws_mrf_ppp_full.pdf')
plot4 <- ppp_plots[[1]][2]
ggsave('figures/ws_mrf_ppp_sum.pdf')
```
