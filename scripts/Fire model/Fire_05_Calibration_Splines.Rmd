...
```{r}
p1 <- PlotPredTrueDensity(gam_results, n = 1584)
p2 <- PlotPredTrueDirection(gam_results, n = 1584)
p3 <- PlotPredTrueBurn(gam_results, n = 1584)
...
```{r}
PlotPredTrueDirection(gam_results, n = 1584)

ggsave('figures/fire_GAM_predtrue_direction.pdf')
```
...
```{r}
PlotErrorsDensity(gam_errors, n_plot = c(99, 792, 1584))

ggsave('figures/fire_GAM_density_metrics.pdf')
```
F1, kappa score, and MCC for directions:
```{r}
PlotErrorsDirections(gam_errors, n_plot = c(99, 792, 1584))
