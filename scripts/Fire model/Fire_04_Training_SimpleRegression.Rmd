...
A function to compute the errors made by the simple linear and logistic regressions:
```{r}
...
# similar but select noie variables
...
```{r}
errors %>%
  write_csv(file = 'data/results/fire_errors.csv')
```
