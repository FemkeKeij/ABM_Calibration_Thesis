...
data_time_full_outputnoise <- fire_training %>%
  ...
  select(time_label, density, directions, burn_percentage_noise,
         total_ticks, mean_burn_noise, min_burn_noise,
         max_burn_noise, trend_burn_noise, sd_burn_noise) %>%
  rename(mean_burn = mean_burn_noise,
         min_burn = min_burn_noise,
         max_burn = max_burn_noise,
...
data_time_sum_outputnoise <- fire_training %>%
  ...
  select(time_label, density, directions, burn_percentage_noise,
         total_ticks, mean_burn_noise, min_burn_noise,
         max_burn_noise, sd_burn_noise, trend_burn_noise) %>%
  rename(mean_burn = mean_burn_noise,
         min_burn = min_burn_noise,
         max_burn = max_burn_noise,
         sd_burn = sd_burn_noise,
...
data_end_full_outputnoise <- fire_training %>%
  filter(datapoints == 'endpoints',
         summarise_runs == 'full') %>%
  select(time_label, density, directions, burn_percentage_noise,
         mean_burn_noise, min_burn_noise, max_burn_noise,
