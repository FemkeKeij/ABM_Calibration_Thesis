...
# Fitting
```{r}
fit_density <- randomForest(density ~ burn_percentage + directions + ticks,
                            data = fire_train)
fit_direction <- randomForest(directions ~ burn_percentage + density + ticks,
                              data = fire_train)

predict(fit_density, newdata = fire_test)
